...
OPEN_ROWS: list[dict[str, Any]] = [
    ...
    {"id": "T-071", "order": 710, "program": "eden", "status": "queued", "surfaces": ["LEFT", "ORBAT"], "impact": ["ui", "state"], "title": "ORBAT authoring UI", "summary": "Author squads and slots in left ORBAT panel.", "depends_on": ["T-068"], "route": "/missions/:id/edit"},

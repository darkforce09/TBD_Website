...
| **T-060** | Fast load + save — T-060..T-060.1.4 code complete; save mid-upload FIXED (curl 140 MB → 201); browser Save → 201 = user's final check before tag | [`t060_fast_initial_load.md`](../Design_Docs/Mission_Creator_Architecture/t060_fast_initial_load.md) · [`t060_1_scale_load_save_completion.md`](../Design_Docs/Mission_Creator_Architecture/t060_1_scale_load_save_completion.md) |
| **T-060.1** | Determinate load + save upload timeouts (**code complete**) | [`t060_1_scale_load_save_completion.md`](../Design_Docs/Mission_Creator_Architecture/t060_1_scale_load_save_completion.md) |
| **T-060.1.1** | IDB restoring phase + paint fix (**code complete**, load partial pass) | [`t060_1_scale_load_save_completion.md`](../Design_Docs/Mission_Creator_Architecture/t060_1_scale_load_save_completion.md) §T-060.1.1 |
| **T-060.1.2** | Save upload fixes — E1/E2/E3b ✅ | [`t060_1_scale_load_save_completion.md`](../Design_Docs/Mission_Creator_Architecture/t060_1_scale_load_save_completion.md) §T-060.1.2 |
...
| **T-060.1.4** | Fix mid-upload socket reset @ ~135 MB — **code complete**; 1 MB global cap had reached the version route (hardened `GlobalBodyLimit` skip + production-like IT; curl 140 MB → 201); browser Save → 201 pending | [`t060_1_scale_load_save_completion.md`](../Design_Docs/Mission_Creator_Architecture/t060_1_scale_load_save_completion.md) §T-060.1.4 |
| **T-061..T-067** | Scale program → 1M–10M authored mission entities (after T-060 tag) | MC [`ROADMAP.md`](../Design_Docs/Mission_Creator_Architecture/ROADMAP.md) §Map performance |

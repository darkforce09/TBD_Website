...
**T-058** — toolbelt entity-count telemetry (total + selected slots). Then the **T-059..T-063 scale program** toward 100k+ editable entities. Eden P1 resumes at **T-064+**.
